...
# Чтение всех : python manage.py order read
# Обновление клиента: python manage.py order update --order_id 1 --client_id 2
# Удаление клиента: python manage.py order delete --id 1
